...
import { List, Pause, Play, RefreshCw, Search, ArrowRight, X } from 'lucide-react';
...
export default function SinglyLinkedList() {
  ...
  const [highlightLineNum, setHighlightLineNum] = useState(-1); // <-- FIX: Added this state
  ...
  const handleReset = () => {
    ...
    setHighlightLineNum(-1); // <-- FIX: Added this line
    setExecutionLog([]);
